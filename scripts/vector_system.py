...
class VectorSystem(System):
    ...
    def on_draw(self):
        ...
        self.result = Physics2dManager.meter2pixel(self.pu * p2Vec2.dot(self.pu, self.pv) / p2Vec2.dot(self.pv, self.pv))
        graphics2d_manager.draw_vector(self.result, Vec2f(400, 400), Color.Red)

        self.result = Physics2dManager.meter2pixel( self.pu + self.pv)
        ...
        graphics2d_manager.draw_vector(self.result, Vec2f(600, 400), Color.Red)
